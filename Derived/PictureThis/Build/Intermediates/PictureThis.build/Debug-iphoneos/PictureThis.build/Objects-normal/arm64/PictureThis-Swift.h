...
SWIFT_CLASS("_TtC11PictureThis11AppDelegate")
...
SWIFT_CLASS("_TtC11PictureThis14ViewController")
...
- (IBAction)didPressTakePhoto:(UIButton * __nonnull)sender;
- (IBAction)didPressTakeAnother:(id __nonnull)sender;
